...
constant::
    ...
    [ [4.84605561...] + [+/-...]*I [-3.77845406...] + [+/-...]*I  [1.47302427...] + [+/-...]*I]
...
An example kindly provided by Christoph Koutschan::
    ...
    sage: eval_diffeq(dop, list(ini), [0, 84]) # long time (5.5 s)
...
def transition_matrix(dop, path, eps=1e-16):
    ...
    TESTS::
        ...
        [ [2.068475...e-7...] [1.000003...] [1.000000...] [0.7500000...] [0.5000095...] [0.3124993...] [0.1878035...] [0.1093771...] [0.06238342...] [0.4144342...]]
...
def eval_diffeq(dop, ini, path, eps=1e-16):
    ...
    Some harder examples::
        ...
        sage: eval_diffeq(dop, [0,i,0], path, 1e-100) # long time (9.61 s)
