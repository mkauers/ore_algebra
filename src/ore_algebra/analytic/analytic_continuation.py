...
class Context(object):
    ...
    def __init__(self, dop, path, eps, keep="last",
        ...
        self.binary_splitting_eps_threshold = bounds.IR(1e-200)
...
def ordinary_step_transition_matrix(ctx, step, ring, eps, rows, pplen=2):
    ...
    elif (isinstance(step[0], NumberFieldElement)
          and isinstance(step[1], NumberFieldElement)
          and eps < ctx.binary_splitting_eps_threshold):
