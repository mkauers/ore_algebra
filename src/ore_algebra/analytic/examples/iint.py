...
::
    ...
    sage: from ore_algebra.analytic.examples.iint import *
    ...
    [0.97080469562493...]
    sage: iint_value(dop, myini, 1e-500) # long time (17.3 s, unstable)
...
Known exact values::
    ...
    sage: for k in sorted(word.keys()): # long time (36 s, quite unstable)
    ....:     dop = diffop(word[k])
...
from ... import DifferentialOperators
